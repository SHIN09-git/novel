...
export function projectData(data: AppData, projectId: ID) {
  return {
    ...
    characterStateFacts: data.characterStateFacts.filter((item) => item.projectId === projectId),
    characterStateTransactions: data.characterStateTransactions.filter((item) => item.projectId === projectId),
    characterStateChangeCandidates: data.characterStateChangeCandidates.filter((item) => item.projectId === projectId),
