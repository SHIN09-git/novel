...
import { RunTraceAuthorSummaryCard } from './RunTraceAuthorSummaryCard'
import { buildRunTraceSummary } from './runTraceSummary'

export { buildRunTraceSummary } from './runTraceSummary'
  ...
  return (
    <div className="panel run-trace-panel">
      ...
      {!trace ? (
        ...
        <>
          <RunTraceAuthorSummaryCard trace={trace} authorSummary={authorSummary} onGenerateAuthorSummary={onGenerateAuthorSummary} />
