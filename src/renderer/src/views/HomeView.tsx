  ...
  async function deleteProject(project: Project) {
    ...
    await saveData((current) => {
      ...
      return {
        ...
        characterStateFacts: current.characterStateFacts.filter((item) => item.projectId !== project.id),
        characterStateTransactions: current.characterStateTransactions.filter((item) => item.projectId !== project.id),
        characterStateChangeCandidates: current.characterStateChangeCandidates.filter((item) => item.projectId !== project.id),
